...
function init_gear_sets()
    ...
    sets.precast.CorsairRoll = {main="Rostam",range="Compensator",
        ...
        body="Malignance Tabard",hands="Chasseur's Gants +1",ring1="Defending Ring",ring2="Luzaf's Ring",
	...
	sets.precast.WS['Evisceration'].Acc = {ammo=gear.WSbullet,
        ...
        sets.precast.WS['Savage Blade'] = {
          ...
          ring2="Karieyh ring",   -- __, __, __, __,  5, __, ___
          back=gear.COR_WS2_Cape,       -- 30, __, 20, 20, 10, __, ___
          waist="Sailfi Belt +1",       -- 15, __, 15, __, __, __, __
        }
	...
	-- Weapons sets
	sets.weapons.Default = {main="Naegling",sub="Nusku Shield",range="Anarchy +2"}
	...
	sets.weapons.DualLeadenRanged = {main="Rostam",sub="Tauret",range="Anarchy +2"}
	sets.weapons.DualLeadenMelee = {main="Naegling",sub="Atoyac",range="Anarchy +2"}
	sets.weapons.DualAeolian = {main="Rostam",sub="Tauret",range="Anarchy +2"}
	sets.weapons.DualLeadenMeleeAcc = {main="Naegling",sub="Blurred Knife +1",range="Anarchy +2"}
	sets.weapons.DualRanged = {main="Rostam",sub="Kustawi +1",range="Anarchy +2"}
    ...
    sets.engaged = {
		...
		back=gear.tp_jse_back,waist="Windbuffet Belt +1",legs="Malignance Tights",feet=gear.herculean_ta_feet}
    ...
    sets.engaged.DT = {
      ...
      ring1="Karieyh ring",             -- __, __, __ < 3,  3, __> [__/__, ___]
