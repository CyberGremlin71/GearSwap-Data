...
function init_gear_sets()
    ...
    sets.precast.FC = {
        main="Kali", --7% FC
		sub="Genmei Shield",
        head="Telchine Cap", --12% song casting
        body="Inyanga Jubbah +2", --14% FC
        hands="Gende. Gages +1", --7% FC/5% song casting
        legs="Ayanmo Cosciales +2", --6% FC
        feet="Telchine Pigaches", --5% FC/6% song casting
    ...
    sets.precast.FC.BardSong = set_combine(sets.precast.FC, {
        main="Kali", --7
		sub="Genmei Shield",
        head="Fili Calot +1", --14% song casting
        body="Inyanga Jubbah +2", --14
        hands="Gende. Gages +1", --7% FC/5% song casting
        legs="Ayanmo Cosciales +2", --6
        feet="Telchine Pigaches", --5% FC
    ...
    sets.precast.FC.SongPlaceholder = set_combine(sets.precast.FC.BardSong, {range="Daurdabla"})
    ...
    sets.precast.WS['Evisceration'] = set_combine(sets.precast.WS, {range={ name="Linos", augments={'Accuracy+15','"Dbl.Atk."+2','Quadruple Attack +3',}},
    ...
    sets.midcast.SongStringSkill = {main="Carnwenhan",
    sub="Ammurapi Shield",
    range="Daurdabla",
    head="Brioso Roundlet +3",
    neck="Mnbw. Whistle +1",
    ...
    sets.idle.MEva = {
        ...
        hands="Raetic Bangles +1",
        legs="Nyame Gauntlets", --0/6
        feet="Nyame Flanchard", --0/3
    ...
    sets.engaged = {range={ name="Linos", augments={'Accuracy+15','"Dbl.Atk."+2','Quadruple Attack +3',}},
    ...
    sets.engaged.DW = {range={ name="Linos", augments={'Accuracy+15','"Dbl.Atk."+2','Quadruple Attack +3',}},
    ...
    sets.Twashtar = {main="Gleti's Dagger", sub="Centovente"}
