...
function user_job_setup()
	...
	gear.obi_nuke_back = "Toro Cape"
		...
		send_command('alias sd_2 input /ma "Cure III" <t>')
		send_command('alias sd_3 input /ma "Cure IV" <t>')
		send_command('alias sd_4 input /ma "Cure V" <t>')
		send_command('alias sd_5 input /ma "Cure VI" <t>')
		send_command('alias sd_6 input /ma "Haste" <t>')
		send_command('alias sd_7 input /ma "Curaga III" <t>')
		send_command('alias sd_8 input /ma "Curaga IV" <t>')
		send_command('alias sd_9 input /ma "Paralyzed" <t>')
		send_command('alias sd_12 input /ma "Erase" <t>')
		send_command('alias sd_13 input /ma "Cursna" <t>')
		send_command('alias sd_14 input /ma "Protectra V" <t>')
