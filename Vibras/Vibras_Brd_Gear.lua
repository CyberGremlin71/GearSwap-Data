function user_job_setup()
	...
	state.Weapons:options('Carnwenhan','Naegling','Aeneas','DualWeapons','DualNaegling','DualTauret','DualAeolian')
...
function init_gear_sets()
	...
	sets.precast.FC = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",ammo="Impatiens",
		...
		body="Fili Hongreline +1",hands="Leyline Gloves",ring1="Kishar Ring",ring2="Lebeche Ring",
		back=gear.magic_jse_back,waist="Witful Belt",legs="Aya. Cosciales +2",feet="Bihu Slippers +3"}
	...
	sets.midcast.SongEffect = {main="Carnwenhan",sub="Genmei Shield",range="Daurdabla",ammo=empty,
		...
		back=gear.magic_jse_back,waist="Kobo Obi",legs="Inyanga Shalwar +2",feet="Brioso slippers +3"}
	...
	sets.midcast.SongDebuff = {main="Carnwenhan",sub="Ammurapi Shield",range="Marsyas",ammo=empty,
		head="Fili Calot +1",neck="Mnbw. Whistle +1",ear1="Regal Earring",ear2="Digni. Earring",
	...
	sets.midcast.SongRecast = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",range="Daurdabla",ammo=empty,
		...
		body="Fili Hongreline +1",hands="Gendewitha Gages +1",ring1="Kishar Ring",ring2="Prolix Ring",
		back=gear.magic_jse_back,waist="Witful Belt",legs="Inyanga shalwar +2",feet="Aya. Gambieras +2"}
	...
	sets.resting = {main="Chatoyant Staff",sub="Umbra Strap",ammo="Staunch Tathlum +1",
		...
		back="Umbra Cape",waist="Flume Belt +1",legs="Inyanga shalwar +2",feet=gear.chironic_refresh_feet}
